class Bank4 {
    ...
    Bank4(String bankName, String area, String phoneNumber) { // Parameterized constructor
    ...
    public static void main(String[] args){
        ...
        Bank4 bank = new Bank4("IBank", "Jaydev Nagar", "8876543210"); //call default constructor
